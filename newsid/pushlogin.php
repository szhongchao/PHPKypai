...
class qq_qrlogin{
	...
	public function getqrpic(){
		$uin=empty($_GET['uin'])?exit('{"saveOK":-1,"msg":"QQ不能为空"}'):$_GET['uin'];
		$url='http://ptlogin2.qq.com/ptqrshow?qr_push_uin='.$uin.'&type=1&qr_push=1&appid=549000912&t=0.589945'.time().'&ptlang=2052&daid=5';
	...
	public function qqlogin(){
		...
		$sig=$this->login_sig();
		$url='http://ptlogin2.qq.com/ptqrlogin?u1=http%3A%2F%2Fqzs.qq.com%2Fqzone%2Fv5%2Floginsucc.html%3Fpara%3Dizone&ptqrtoken='.$this->getqrtoken($qrsig).'&ptredirect=0&h=1&t=1&g=1&from_ui=1&ptlang=2052&action=0-0-'.time().'000&js_ver=10194&js_type=1&login_sig='.$sig.'&pt_uistyle=40&aid=549000912&daid=5&has_onekey=1&';
